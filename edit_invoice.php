	    	...
	    	<div class="load-animate animated fadeInUp">
		    	...
		    	<div class="row">
		      		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
						...
						<p>GST NO. <b>03EDWPD1691F1ZH</b> </p>
		      		...
		      		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
						...
						<div class="form-group">
                  			<input value="<?php echo $invoiceValues['order_reciever_gst']; ?>" type="text" class="form-control" name="companyGst" id="companyGst" placeholder="GST No." autocomplete="off">
               			</div>
						<div class="form-group">
